...
public class AdbDevice {
    ...
    private final AdbBaseActivity mActivity;
    ...
    public AdbDevice(AdbBaseActivity activity, UsbDeviceConnection connection,
                     UsbInterface intf) {
        mActivity = activity;
    ...
    public AdbDevice(AdbBaseActivity activity, UsbDeviceConnection connection, UsbInterface intf, AdbMessageListener listener) {
        mActivity = activity;
        mDeviceConnection = connection;
        mSerial = connection.getSerial();
    ...
    public AdbSocket openSocket(String destination) {
        ...
        synchronized (mSockets) {
            ...
            L.i("openSocket id = "+id);
            socket = new AdbSocket(this, id,mActivity,listener);
    ...
    void dispatchMessage(AdbMessage message) {
        ...
        //L.i("arg0:"+message.getArg0());
        //L.i("arg1:"+message.getArg1());
        switch (command) {
